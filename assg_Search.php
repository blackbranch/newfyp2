...
$query = "SELECT * FROM hotels WHERE hotelName LIKE '%$userSearch%'";
...
<?php include "stylesheets/assignmentStylesheet.css"; ?>
    ...
    <body>
        ...
        <div class="formheader hotelListHeader">
            <h1>Search Result for: '<?php echo $userSearch ?>'</h1>
            <hr>
        </div>
        ...
        <?php } else { ?>
        <div class="alert alert-danger reviewTableMargin" style="text-align:center">
