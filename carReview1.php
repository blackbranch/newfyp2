...
<html>
    ...
    <body>
        ...
        <br><br><br><br>
        <div class="formBox">
            <form method="post" action="doReview1.php">
                Car Name:<br><input type="text" name="carname" size="41" value="Mclaren 720" readonly><br><br>
...
<body>
    ...
    <br><br><br><br>
    <div class="formBox">
        <form method="get" action="doReview1.php">
            Car Name:<br><input type="text" name="carname" size="41" value="Mclaren 720" readonly><br><br>
            Username:<br><input type="text" name="username" size="41"><br><br>
            Comments:<br>
            <textarea name="comment" rows="5" cols="40"></textarea><br><br>
