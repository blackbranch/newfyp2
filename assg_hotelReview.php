    ...
    <body>
                ...
                <?php if (!empty($arrReview)) { ?>
                    ...
                    for ($x = 0; $x < count($arrReview); $x++) {
                        ...
                        <tr>
                            ...
                            <td><?php if ($userId == $_SESSION['userId']) { ?><a href="assg_reviewEdit.php?id=<?php echo $hotelID ?>&reviewId=<?php echo $reviewId ?>&userId=<?php echo $userId ?>"><button class="btn btn-light" type="button">Edit</button></a><?php } ?></td>
                            <td><?php if ($userId == $_SESSION['userId']) { ?><a href="assg_ReviewDelete.php?hotelId=<?php echo $hotelId ?>&reviewId=<?php echo $reviewId ?>"><button class="btn btn-danger" type="button">Delete</button></a><?php } ?></td>
                        </tr>
                    <?php } ?> 
                <?php } ?>
            </table>
        ...
        <div class="d-flex justify-content-center">
            <div class="d-flex flex-row justify-content-around" style="width:250px">
                <a href="assg_hotels.php"><button class="btn btn-dark" type="button">Back to Hotels</button></a>
                <a href="assg_reviewAdd.php?id=<?php echo $hotelID ?>"><button class="btn btn-dark" type="button">Add review</button></a>
            </div>
        </div>
    </body>
</html>
